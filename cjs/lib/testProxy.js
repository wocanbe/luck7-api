...
var handlers        = require('http-proxy-middleware/lib/handlers');
...
var logger          = require('http-proxy-middleware/lib/logger').getInstance();
var getArrow        = require('http-proxy-middleware/lib/logger').getArrow;
var {addCrosHeader} = require('./utils')
...
function HttpProxyMiddleware(context, opts) {
    ...
    function middleware(req, res, next) {
        if (req.method === 'OPTIONS') {
            addCrosHeader(req, res, opts.isCookie, opts.allowHeader)
        } else {
